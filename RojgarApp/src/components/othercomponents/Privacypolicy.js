  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.heading}>WHAT DO WE DO WITH YOUR INFORMATION?</Text>
        ...
        <Text style={styles.texts}>How do you get my consent?</Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.texts}>
          ...
          info@applymyform.com or mailing us at: Apply My Form, VPO Jhojhu
          Kalan, Charkhi Dadri.
        </Text>
        <Text style={styles.heading}>DISCLOSURE</Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.texts}>
          ...
          Policy or our website’s Terms of Service. Links
        </Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.heading}>AGE OF CONSENT</Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.heading}>QUESTIONS AND CONTACT INFORMATION</Text>
        <Text style={styles.texts}>
          ...
          info@applymyform.com or by mail at ApplyMyForm, VPO Jhojhu Kalan,
          Charkhi Dadri
        </Text>
        <Text style={styles.texts}>[Re: Privacy Compliance Officer]</Text>
        <Text style={styles.texts}>
          [Apply My Form, VPO Jhojhu Kalan,Charkhi Dadri]
        </Text>
      </View>
    </ScrollView>
  );
