    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text style={styles.texts}>
          This website is operated by Apply My Form App Throughout the site,
          the terms “we”, “us” and “our” refer to Apply My Form. Apply My Form
        ...
        <Text style={styles.texts}>
          ...
          an offer, acceptance is expressly limited to these
        </Text>
        ...
        <Text style={styles.heading}>ONLINE STORE TERMS</Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.heading}>PRODUCTS OR SERVICES</Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.texts}>
          For more detail, please review our Returns Policy. SECTION 7 -
          OPTIONAL TOOLS
        </Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.heading}>ERRORS, INACCURACIES AND OMISSIONS</Text>
        <Text style={styles.texts}>
        ...
        <Text style={styles.texts}>
          In no case shall Apply My Form App, our directors, officers,
        ...
        <Text style={styles.texts}>
          You agree to indemnify, defend and hold harmless Apply My Form App and
        ...
        <Text style={styles.heading}>CHANGES TO TERMS OF SERVICE</Text>
        <Text style={styles.texts}>
